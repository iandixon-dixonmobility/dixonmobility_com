                ...
                <div className="items-center gap-x-12 lg:flex">
                    ...
                    <div className="max-w-xl mt-6 md:mt-0 lg:max-w-2xl">
                        ...
                        <p className="mt-3 text-gray-600">
                            We have been publishing public transit apps for riders since 2012, and with over <b>5 million downloads</b> in the Apple App Store and Google Play Store, Dixon Mobility is a proven leader in mobile public transit. Our success is built around tailoring each app for the market it serves and the unique characteristics of the transit system.
                        </p>
                        <NavLink
                            href="/get-started"
